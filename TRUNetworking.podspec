...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/qiweiqiang/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'qiweiqiang' => 'qiweiqiang@people.cn' }
  s.source           = { :git => 'https://github.com/qiweiqiang/TRUNetworking.git', :tag => s.version.to_s }
